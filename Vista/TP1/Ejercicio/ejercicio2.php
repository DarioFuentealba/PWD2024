...
<div class="divform">
  <form action="../Accion/eje2accion.php" method="get" id="form2" name="form2">
      ...
      Mi&eacute;rcoles: <input type="number" id="miércoles" name="miércoles" value="0" max='23' min="0" step="1" required><br><br>
    ...
    <button type="submit" class="btn-tp1" role="button">Horas Totales</button>
  </form>
</div>
