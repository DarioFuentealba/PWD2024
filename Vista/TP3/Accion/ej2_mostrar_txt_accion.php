<?php
    ...
    if(!empty(data_submitted()))
    {
        ...
        if($respuesta === '0')
        {
            ...
            $mensaje .= 'Textarea donde muestro el contenido del archivo<br><textarea name="muestraInformacion" rows="25" cols="70">' . $informacion . '</textarea>';
            ...
            $mensaje = '<p>ERROR: El tipo de archivo no está permitido. Sólo se pueden cargar archivos .txt</p><br>';
