...
<div class="divform">
  <form action="../Accion/ej2-2accion.php" method="get" id="miFormulario" name="form2">
      Lunes:<input type="text" id="lunes" name="lunes" class="dia"><br><br>

      Martes:<input type="text" id="martes" name="martes" class="dia"><br><br>

      Mi&eacute;rcoles:<input type="text" id="miercoles" name="miercoles" class="dia"><br><br>

      Jueves:<input type="text" id="jueves" name="jueves" class="dia"><br><br>

      Viernes:<input type="text" id="viernes" name="viernes" class="dia"><br><br>
